...
const I18N = {
  en: {
    ...
    'section.waiting_hidden': '{n} waiting — tap button below to show',
    ...
    'btn.skip_task': 'Skip occurrence', 'btn.duplicate': 'Duplicate',
    'modal.duplicate_task': 'Duplicate Task',
    'label.notify_weekday': 'Mon–Fri notify time', 'label.notify_weekend': 'Sat–Sun notify time',
  ...
  de: {
    ...
    'section.waiting_hidden': '{n} wartend — unten einblenden',
    ...
    'btn.skip_task': 'Termin überspringen', 'btn.duplicate': 'Duplizieren',
    'modal.duplicate_task': 'Aufgabe duplizieren',
    'label.notify_weekday': 'Mo–Fr Uhrzeit', 'label.notify_weekend': 'Sa–So Uhrzeit',
