...
const I18N = {
  en: {
    ...
    'undo.completed': '"{name}" completed', 'undo.deleted': '"{name}" deleted', 'undo.btn': 'Undo',
    ...
    'archive.count': '{n} archived tasks', 'history.count': '{n} completions',
    'snooze.hint': '⏰ Snoozed until {time}',
    'snooze.title': '⏰ Snooze', 'snooze.label': 'Postpone for…',
    'snooze.chip_15m': '15 min', 'snooze.chip_30m': '30 min', 'snooze.chip_1h': '1 hour', 'snooze.chip_2h': '2 hours',
    'snooze.chip_4h': '4 hours', 'snooze.chip_1d': '1 day', 'snooze.chip_3d': '3 days',
    'snooze.custom_amount': 'Amount', 'snooze.custom_unit': 'Unit',
    'snooze.unit_minutes': 'Minutes', 'snooze.unit_hours': 'Hours', 'snooze.unit_days': 'Days',
    'snooze.current': 'Postponed until {time}', 'snooze.cancel': 'Cancel snooze',
    ...
    'label.notify_enabled': 'Notify', 'desc.notify_enabled': 'Send reminders via configured channels',
    ...
    'btn.skip_task': 'Skip occurrence', 'btn.duplicate': 'Duplicate', 'btn.history': 'History',
    'btn.edit': 'Edit', 'btn.delete': 'Delete', 'btn.more': 'More', 'btn.snooze': 'Snooze',
    'photo.add': '📷 Add photo', 'photo.change': '📷 Change', 'photo.remove': 'Remove',
    'nlp.title': '✨ Quick Add', 'nlp.label': 'Describe your task', 'nlp.parse_btn': 'Create Task',
    'nlp.placeholder': 'e.g. Water plants every Friday · Clean kitchen weekly',
    'vacation.title': 'Vacation Mode', 'vacation.label': 'Activate vacation mode',
    'vacation.desc': 'Pause all tasks and notifications for a period',
    'vacation.from': 'From', 'vacation.to': 'To',
    'vacation.banner': 'Vacation mode active — tasks paused until',
    'empty.sub': 'Enjoy the break ✌️',
    'settings.weekly_summary': 'Weekly Summary',
    'label.weekly_summary': 'Send weekly summary',
    'desc.weekly_summary': 'Monday morning email/HA notification with completed tasks',
    'modal.duplicate_task': 'Duplicate Task', 'modal.history_title': 'Completion History',
    'label.notify_channel': 'Notification channel', 'desc.notify_ha': 'Push via HA Companion App', 'desc.notify_email': 'Reminder via email',
    'label.notify_weekday': 'Mon–Fri notify time', 'label.notify_weekend': 'Sat–Sun notify time',
    'label.subtasks': 'Subtasks (Checklist)', 'btn.add_step': '+ Add step', 'placeholder.subtask': 'Step…',
    ...
    'settings.tab_general': 'General', 'settings.tab_users': 'Users & Rooms',
    'settings.tab_ha': 'HA', 'settings.tab_backup': 'Backup',
    'label.archive_days': 'Archive retention (days)', 'label.planning_days': 'Planning horizon (days)',
    'settings.notifications': 'Notifications',
    'label.completion_notify': 'Notify others on completion',
    'desc.completion_notify': 'Push to other household members when someone completes a task',
    'label.repeat_notify_hours': 'Repeat reminder after (hours)',
  ...
  de: {
    ...
    'undo.completed': '"{name}" erledigt', 'undo.deleted': '"{name}" gelöscht', 'undo.btn': 'Rückgängig',
    ...
    'archive.count': '{n} archivierte Aufgaben', 'history.count': '{n} Erledigungen',
    'snooze.hint': '⏰ Später erinnert um {time}',
    'snooze.title': '⏰ Zurückstellen', 'snooze.label': 'Zurückstellen um…',
    'snooze.chip_15m': '15 Min.', 'snooze.chip_30m': '30 Min.', 'snooze.chip_1h': '1 Stunde', 'snooze.chip_2h': '2 Stunden',
    'snooze.chip_4h': '4 Stunden', 'snooze.chip_1d': '1 Tag', 'snooze.chip_3d': '3 Tage',
    'snooze.custom_amount': 'Anzahl', 'snooze.custom_unit': 'Einheit',
    'snooze.unit_minutes': 'Minuten', 'snooze.unit_hours': 'Stunden', 'snooze.unit_days': 'Tage',
    'snooze.current': 'Zurückgestellt bis {time}', 'snooze.cancel': 'Zurückstellen aufheben',
    ...
    'label.notify_enabled': 'Benachrichtigen', 'desc.notify_enabled': 'Erinnerungen über die konfigurierten Kanäle senden',
    ...
    'btn.skip_task': 'Termin überspringen', 'btn.duplicate': 'Duplizieren', 'btn.history': 'Verlauf',
    'btn.edit': 'Bearbeiten', 'btn.delete': 'Löschen', 'btn.more': 'Mehr', 'btn.snooze': 'Zurückstellen',
    'photo.add': '📷 Foto hinzufügen', 'photo.change': '📷 Ändern', 'photo.remove': 'Entfernen',
    'nlp.title': '✨ Schnell hinzufügen', 'nlp.label': 'Aufgabe beschreiben', 'nlp.parse_btn': 'Aufgabe erstellen',
    'nlp.placeholder': 'z.B. Pflanzen gießen jeden Freitag · Küche putzen wöchentlich',
    'vacation.title': 'Urlaubsmodus', 'vacation.label': 'Urlaubsmodus aktivieren',
    'vacation.desc': 'Alle Aufgaben und Benachrichtigungen für einen Zeitraum pausieren',
    'vacation.from': 'Von', 'vacation.to': 'Bis',
    'vacation.banner': 'Urlaubsmodus aktiv — Aufgaben pausiert bis',
    'empty.sub': 'Gönne dir eine Pause ✌️',
    'settings.weekly_summary': 'Wochenzusammenfassung',
    'label.weekly_summary': 'Wöchentliche Zusammenfassung senden',
    'desc.weekly_summary': 'Montagmorgens E-Mail/HA-Benachrichtigung mit erledigten Aufgaben',
    'modal.duplicate_task': 'Aufgabe duplizieren', 'modal.history_title': 'Verlauf',
    'label.notify_channel': 'Benachrichtigungskanal', 'desc.notify_ha': 'Push via HA Companion App', 'desc.notify_email': 'Erinnerung per E-Mail',
    'label.notify_weekday': 'Mo–Fr Uhrzeit', 'label.notify_weekend': 'Sa–So Uhrzeit',
    'label.subtasks': 'Unteraufgaben (Checkliste)', 'btn.add_step': '+ Schritt hinzufügen', 'placeholder.subtask': 'Schritt…',
    ...
    'settings.tab_general': 'Allgemein', 'settings.tab_users': 'Nutzer & Räume',
    'settings.tab_ha': 'HA', 'settings.tab_backup': 'Backup',
    'label.archive_days': 'Archivdauer (Tage)', 'label.planning_days': 'Planungszeitraum (Tage)',
    'settings.notifications': 'Benachrichtigungen',
    'label.completion_notify': 'Andere bei Erledigung benachrichtigen',
    'desc.completion_notify': 'Push an andere Haushaltsmitglieder, wenn jemand eine Aufgabe erledigt',
    'label.repeat_notify_hours': 'Erinnerung wiederholen nach (Stunden)',
