# 🏠 Steward — Home Assistant Add-on

[![Version](https://img.shields.io/badge/version-1.11.0-blue?style=flat-square)](https://github.com/fahrstuhl1/steward-ha/blob/main/steward/CHANGELOG.md)
...
3. Category: **Add-on**
4. Add → the repository appears in the list
5. Find the add-on → **Install**

### Manual Installation

1. In Home Assistant go to **Settings → Add-ons → Add-on Store** → ⋮ → **Repositories**
2. Add `https://github.com/fahrstuhl1/steward-ha`
3. Find the add-on and install it
